...
It's a action-based multi-player shooting game using [Leap Motion](https://www.leapmotion.com/) to track a player's hand movements and gestures for control.

It adopts a scoring mechanism using principles of [Game Theory](http://en.wikipedia.org/wiki/Game_theory), where in order to get highest score, a player can, depending on the best strategy at the moment, choose to:<br>
